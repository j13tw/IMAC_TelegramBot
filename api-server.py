...
def ups_update(sequence):
    if request.method == 'POST':
        ...
        try:
            ...
            ups_a_data["connect"]    
            ups_a_data["upsLife"]
            ups_a_data["input"]["line"]
            ups_a_data["input"]["freq"]
            ups_a_data["input"]["volt"]
            ups_a_data["output"]["systemMode"]
            ups_a_data["output"]["line"]
            ups_a_data["output"]["freq"]
            ups_a_data["output"]["volt"]
            ups_a_data["output"]["outputAmp"]
            ups_a_data["output"]["outputPercent"]
            ups_a_data["battery"]["status"]["health"]
            ups_a_data["battery"]["status"]["status"]
            ups_a_data["battery"]["status"]["chargeMode"]
            ups_a_data["battery"]["status"]["remain_Min"]
            ups_a_data["battery"]["status"]["remain_Sec"]
            ups_a_data["battery"]["status"]["volt"]
            ups_a_data["battery"]["status"]["temp"]
            ups_a_data["battery"]["status"]["remainPercent"]
            ups_a_data["battery"]["lastChange"]["year"]
            ups_a_data["battery"]["lastChange"]["month"]
            ups_a_data["battery"]["lastChange"]["day"]
            ups_a_data["battery"]["nextChange"]["year"]
            ups_a_data["battery"]["nextChange"]["month"]
            ups_a_data["battery"]["nextChange"]["day"]
        except:
